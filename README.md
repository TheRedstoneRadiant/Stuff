...
- [Social media attack surfaces](https://github.com/sinwindie/OSINT)

- [List of OSINT tools](https://github.com/AbhinavBaranwal/OSINT_All-Tools_Almost/blob/master/README.md)

- [Holehe - Find accounts by email address](https://github.com/megadose/holehe)
...
- [Intelligence X - Search through documents](https://intelx.io/)
...
- [Shodan - IoT device lookup](https://www.shodan.io/)

- [ZoomEye - Network device lookup](https://www.zoomeye.org/)

- [urlscan.io - Advanced website lookup](https://urlscan.io)

- [Searchcode - Source code search engine](https://searchcode.com/)

- [Grep.app - Github search engine](https://grep.app/)

- [PublicWWW - Website source code search engine](https://publicwww.com)
